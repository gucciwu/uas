...
public class PermissionController {
    ...
    public @ResponseBody
    AddRoleTypeResponse addRoleType(@RequestBody AddRoleTypeExRequest request, HttpServletRequest httpRequest) throws IpForbbidenException, AppSecretMatchException, OperationFailureException {
    ...
    public @ResponseBody
    DelRoleTypeResponse delRoleType(@RequestBody DelRoleTypeExRequest request, HttpServletRequest httpRequest) throws IpForbbidenException, AppSecretMatchException, OperationFailureException {
    ...
    public @ResponseBody
    AddRoleResponse addRole(@RequestBody AddRoleExRequest request, HttpServletRequest httpRequest) throws IpForbbidenException, AppSecretMatchException, OperationFailureException {
        return service.addRole(request,httpRequest);
    }
    @ApiOperation(value="删除角色", notes="")
    @RequestMapping(value="/permission/del_role",method = RequestMethod.POST)
    public @ResponseBody
    DelRoleResponse delRole(@RequestBody DelRoleExRequest request, HttpServletRequest httpRequest) throws IpForbbidenException, AppSecretMatchException, OperationFailureException {
    ...
    public @ResponseBody
    ModifyRoleResponse modifyRole(@RequestBody ModifyRoleExRequest request, HttpServletRequest httpRequest) throws IpForbbidenException, AppSecretMatchException, OperationFailureException {
    ...
    public @ResponseBody
    AddAppToRoleResponse addAppToRole(@RequestBody AddAppToRoleExRequest request, HttpServletRequest httpRequest) throws IpForbbidenException, AppSecretMatchException, OperationFailureException {
    ...
    public @ResponseBody
    AddRoleToUserResponse addRoleToUser(@RequestBody AddRoleToUserExRequest request, HttpServletRequest httpRequest) throws IpForbbidenException, AppSecretMatchException, OperationFailureException {
