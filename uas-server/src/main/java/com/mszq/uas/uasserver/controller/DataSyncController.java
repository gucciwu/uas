...
public class DataSyncController {
    ...
    public @ResponseBody
    UpdateUserResponse updateUser(@RequestBody UpdateUserExRequest request) {
        ...
        try{
            List<String> ldapUsers = ldapClient.search(request.getUser().getJobNumber());
            if(ldapUsers.size() == 0){
                ldapClient.create(request.getUser().getJobNumber(),"mszq@123");
            }
        }catch(Exception ex){
            ex.printStackTrace();
        }
    ...
    public @ResponseBody
    DelUserResponse delUser(@RequestBody DelUserExRequest request) {
    ...
    public @ResponseBody
    AddIdToAppResponse addIdToApp(@RequestBody AddIdToAppExRequest request) {
    ...
    public @ResponseBody
    DelIdToAppResponse delIdToApp(@RequestBody DelIdToAppExRequest request) {
    ...
    public @ResponseBody
    ChangeIdToAppResponse changeIdToApp(@RequestBody ChangeIdToAppExRequest request) {
    ...
    public @ResponseBody
    ChangePasswordResponse changePassword(@RequestBody ChangePasswordExRequest request) throws IllegalBlockSizeException, InvalidKeyException, NoSuchAlgorithmException, BadPaddingException, NoSuchPaddingException {
    ...
    public @ResponseBody
    ResetPasswordResponse resetPassword(@RequestBody ResetPasswordExRequest request) throws IllegalBlockSizeException, InvalidKeyException, NoSuchAlgorithmException, BadPaddingException, NoSuchPaddingException {
    ...
    public @ResponseBody
    GetUsersResponse getUsers(@RequestBody GetUsersExRequest request) throws ParseException {
    ...
    public @ResponseBody
    GetAppAccountIdResponse getAppAccountId(@RequestBody GetAppAccountIdExRequest request) {
    ...
    public @ResponseBody
    AddOrgResponse addOrg(@RequestBody AddOrgExRequest request) {
    ...
    public @ResponseBody
    DelOrgResponse delOrg(@RequestBody DelOrgExRequest request) {
    ...
    public @ResponseBody
    AddAppResponse getOrgs(@RequestBody AddAppRequest request) {
    ...
    public @ResponseBody
    DelAppResponse getOrgs(@RequestBody DelAppRequest request) {
    ...
    public @ResponseBody
    GetOrgsResponse getOrgs(@RequestBody GetOrgsExRequest request) {
    ...
    public @ResponseBody
    ModifyOrgResponse modifyOrg(@RequestBody ModifyOrgExRequest request){
    ...
    public @ResponseBody
    AddOrgTypeResponse addOrgType(@RequestBody AddOrgTypeExRequest request) {
    ...
    public @ResponseBody
    DelOrgTypeResponse delOrgType(@RequestBody DelOrgTypeExRequest request) {
