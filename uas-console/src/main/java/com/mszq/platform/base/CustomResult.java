...
public class CustomResult {
    ...
    public static CustomResult ok(String msg) {
        return new CustomResult(1,msg,null);
    }
    
    public static CustomResult ok(String msg,Object data) {
        return new CustomResult(1,msg,data);
    }

 
    public static CustomResult error(String msg) {
        return new CustomResult(0, msg, null);
    }
