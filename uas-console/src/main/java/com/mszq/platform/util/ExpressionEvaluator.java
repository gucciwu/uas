...
public class ExpressionEvaluator {
     ...
     * @throws ParseException 
     */  
    public static Object eval(String expression) throws ParseException  
    {  
        return CalcExpression(parseExpression(expression));  
    }  
      
    public static Object evalThreeOperand(String expression) throws ParseException  
    {  
    ...
    public static void main(String[] args){
    	ExpressionEvaluator.parseExpression("(1+3)*5");
    }
